...
#Page 1
sgl_url1 = read_html("http://www.trivago.com/?cpt=3430803&r=&iRoomType=1&aHotelTestClassifier=&iIncludeAll=0&aPartner=&iPathId=34308&aDateRange%5Barr%5D=2016-08-28&aDateRange%5Bdep%5D=2016-08-29&iGeoDistanceItem=0&iViewType=0&bIsSeoPage=false&bIsSitemap=false&")
##Name of Hotel
sgl_name1 = sgl_url1 %>% 
...
write_csv(sgl_final, "sf_sgl.csv")
