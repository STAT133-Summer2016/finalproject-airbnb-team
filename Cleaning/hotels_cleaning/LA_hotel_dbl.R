...
#Page 1
dbl_url1 = read_html("http://www.trivago.com/?cpt=3429803&r=&iRoomType=7&iPathId=34298&aDateRange%5Barr%5D=2016-08-28&aDateRange%5Bdep%5D=2016-08-29&iGeoDistanceItem=0&iViewType=0&bIsSeoPage=false&bIsSitemap=false&")
...
write_csv(dbl_final, "la_dbl.csv")
