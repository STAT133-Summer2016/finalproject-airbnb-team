...
sf <- sf %>% 
  ...
  mutate(price_range = ifelse(price_range < 40, "0-39", as.character(price_range))) %>% 
  mutate(price_range = ifelse(price_range >= 40 & price_range < 100, "40-99", as.character(price_range))) %>% 
...
mutate(price_range = ifelse(price_range >= 200 & price_range < 300, "200-299", as.character(price_range))) %>% 
  mutate(price_range = ifelse(price_range > 300, "300+", as.character(price_range)))
ny$price_range <- as.factor(ny$price_range)
